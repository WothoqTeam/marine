                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-db-table-filter="search" id="search" name="search"
                               ...
                               placeholder="{{transAdmin('Search Marasi')}}"/>
                    </div>
                </div>
                <div class="card-toolbar">
                    <!--begin::Toolbar-->
                    <div class="d-flex justify-content-end dbuttons">
                        <a href="{{route('admin.marasi.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
...
@section('script')
    ...
    <script>
        function changeMarasiStatus(id) {
            var status_id = document.getElementById('changeStatus').value;
            $.ajax(
                {
                    url: "{{route('admin.marasi.updateStatus')}}",
                    type: 'post',
                    dataType: "JSON",
                    data: {
                        "id": id,

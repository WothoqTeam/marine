            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                    ...
                    @foreach($reservations as $reservation)
                        @php
                            $user=\App\Models\User::find($reservation['provider_id']);
                        @endphp
                        <tr>
                            <!--begin::Checkbox-->
                            <td>
                            ...
                            <td data-kt-ecommerce-order-filter="purchase_id">
                                <a href="{{route('admin.mReservations.show',$reservation['id'])}}" class="text-gray-800 text-hover-primary fw-bold">{{$i}}</a>
                            </td>
                            <!--end::purchase ID=-->
                            <!--begin::Customer=-->
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="{{route('admin.providers.show', $reservation['provider_id'])}}">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="{{route('admin.providers.show', $reservation['provider_id'])}}">
                                            <div class="symbol-label fs-3 bg-light-primary text-primary">{{$reservation['provider']['name'][0]}}</div>
                                        </a>
                                    </div>
                                    <!--end::Avatar-->
                                    @endif
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="{{route('admin.providers.show', $reservation['provider_id'])}}" class="text-gray-800 text-hover-primary fs-5 fw-bold">{{$reservation['provider']['name']}}</a>
                                        <!--end::Title-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{route('admin.mReservations.show',$reservation['id'])}}" class="menu-link px-3">{{transAdmin('View')}}</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->

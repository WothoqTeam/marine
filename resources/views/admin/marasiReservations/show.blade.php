                    ...
                    <div class="card-body pt-0">
                        <div class="table-responsive">
                            ...
                            <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                ...
                                <!--end::Payment status-->
                                @if($data['reservations_status']=='canceled')
                                <!--begin::Cancel Reason-->
                                <tr>
                                    <td class="text-muted">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--end::Svg Icon-->{{transAdmin('Cancel Reason')}}
                                        </div>
                                    </td>
                                    <td class="fw-bold text-end">
                                ...
                                <tr>
                                    <td class="text-muted">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--end::Svg Icon-->{{transAdmin('Person Who Cancelled')}}
                                        </div>
                                    </td>
                                    <td class="fw-bold text-end">
                                        <?php
                                            $canceledPerson='';
                                            if (!empty($data['canceled_by'])){
                                                $emp=\App\Models\Employee::find($data['canceled_by']);
                                                $canceledPerson=$emp->name;
                                            }
                                        ?>
                                        {{$canceledPerson}}
                                    </td>
                                ...
                                <div class="my-1 me-5">
                                    @if(Auth::guard('admin')->user()->role_id==2)
                                        ...
                                        @elseif($data['reservations_status']=='in progress')
                                            ...
                                            <!-- end::Completed-->
                                        @elseif($data['reservations_status']=='completed')
                                            <!-- begin::Canceled-->
                                            <button type="button" class="btn btn-danger my-1 me-12"

...
@section('breadcrumb')
    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3 pt-6">
        <!--begin::Title-->
        <h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold fs-3 m-0">{{transAdmin('Yachts Reservations')}} </h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
            ...
            <li class="breadcrumb-item text-muted">
                <a href="{{route('admin.reservations.index')}}"
                   class="text-muted text-hover-primary">{{transAdmin('Yachts Reservations')}} </a>
            </li>
            <!--end::Item-->
            <!--begin::Item-->
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item text-muted">{{transAdmin('Reservation')}} </li>
            <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
    </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                ...
                                <tr>
                                    <td class="text-muted">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--end::Svg Icon-->{{transAdmin('User Name')}}
                                        </div>
                                    </td>
                                    <td class="fw-bold text-end">
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold text-end">{{$data['user']['phone']}}</td>
                                </tr>
                                <!--end::Date-->
                                </tbody>
                                <!--end::Table body-->
...
{{--                    <div class="card-header">--}}
{{--                        <div class="card-title">--}}
{{--                            <h2>{{trans('purchases.bank_documents')}}</h2>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <!--end::Card header-->--}}
{{--                    <!--begin::Card body-->--}}
...
{{--                                                    </svg>--}}
{{--                                                </span>--}}
{{--                                            <!--end::Svg Icon-->{{trans('purchases.bank_receipt')}}--}}
...
{{--                                    </td>--}}
{{--                                    <td class="fw-bold text-end">--}}
{{--                                        <a href="{{$data['bank_receipt']}}" target="_blank" class="text-gray-600 text-hover-primary">{{trans('purchases.view_receipt')}}</a>--}}
{{--                                    </td>--}}
{{--                                </tr>--}}
{{--                                <!--end::Invoice-->--}}
{{--                                <!--begin::Shipping-->--}}
...
{{--                                                </svg>--}}
{{--                                            </span>--}}
{{--                                            <!--end::Svg Icon-->{{trans('purchases.transformer_name')}}--}}
...
{{--                                    </td>--}}
{{--                                    <td class="fw-bold text-end">--}}
{{--                                        <span class="text-gray-600 text-hover-primary">{{$data['transformer_name']}}</span>--}}
{{--                                    </td>--}}
{{--                                </tr>--}}
{{--                                <!--end::Shipping-->--}}
...
{{--                                    <tr>--}}
{{--                                        <td class="text-muted">--}}
{{--                                            <a href="{{route('admin.purchases.update',$data['id'])}}" class="btn btn-primary align-items-center">{{trans('purchases.transfer_completed')}}</a>--}}
{{--                                        </td>--}}
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                        ...
                                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                            <th class="min-w-175px">{{transAdmin('Yachts')}}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $data['yacht']=\App\Models\Yachts::find($data['yacht']['id']);
                                                @endphp
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Thumbnail-->
...
{{--                                        <tr>--}}
                                ...
                                <div class="my-1 me-5">
                                    <!-- begin::Pint-->
                                    <button type="button" class="btn btn-success my-1 me-12" onclick="window.print();">{{transAdmin('Print Invoice')}}</button>
                                    <!-- end::Pint-->
                                </div>
                            </div>
                            <!--end::Card body-->

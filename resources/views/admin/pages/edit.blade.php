...
<div class="page-title d-flex flex-column justify-content-center gap-1 me-3 pt-6">
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{route('admin.pages.index')}}" class="text-muted text-hover-primary">{{trans('labels.settings.pages_tap')}}</a>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form action="{{route('admin.pages.update')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-6">{{trans('labels.inputs.content')}} EN</label>
                            <div class="col-lg-8 fv-row">
                                <textarea name="content_en" placeholder="{{trans('labels.inputs.content')}} EN" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" >{{$data->content_en}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-6">{{trans('labels.inputs.content')}} AR</label>
                            <div class="col-lg-8 fv-row">
                                <textarea name="content_ar" placeholder="{{trans('labels.inputs.content')}} AR" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" >{{$data->content_ar}}</textarea>
                            </div>
                        </div>

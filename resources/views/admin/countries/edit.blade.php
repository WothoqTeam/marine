...
<div class="page-title d-flex flex-column justify-content-center gap-1 me-3 pt-6">
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{route('admin.countries.index')}}" class="text-muted text-hover-primary">{{trans('labels.settings.countries_tap')}}</a>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form action="{{route('admin.countries.update')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-6">{{trans('labels.inputs.currency')}} EN</label>
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="currency_en" placeholder="{{trans('labels.inputs.currency')}} EN" value="{{$data->currency_en}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                            </div>
                        </div>
                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-6">{{trans('labels.inputs.currency')}} AR</label>
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="currency_ar" placeholder="{{trans('labels.inputs.currency')}} AR" value="{{$data->currency_ar}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                            </div>
                        </div>
                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-6">{{trans('labels.inputs.iso_code')}}</label>
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="iso_code" placeholder="{{trans('labels.inputs.iso_code')}}" value="{{$data->iso_code}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                            </div>
                        </div>

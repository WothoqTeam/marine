        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                <li class="breadcrumb-item text-muted px-2">
                    <a href="{{route('admin.gasStations.index')}}"
                       class="text-muted text-hover-primary">{{transAdmin('Gas Stations')}}</a>
                </li>
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-db-table-filter="search" id="search" name="search"
                               ...
                               placeholder="{{transAdmin('Search Gas Stations')}}"/>
                    </div>
                </div>
                <div class="card-toolbar">
                    <!--begin::Toolbar-->
                    <div class="d-flex justify-content-end dbuttons">
                        <a href="{{route('admin.gasStations.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
            ...
            <div class="card-body py-4">
                ...
                <table class="table align-middle table-rounded table-striped table-row-dashed fs-6"
                    ...
                    <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px text-start">{{transAdmin('Gas Stations')}}</th>
    ...
    <script>
        $(function () {
            ...
            var table = $('#kt_datatable_table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.gasStations.index') }}",
                    data: function (d) {
                        d.search = $('#search').val()
                    }
                },
                ...
                if (checkIDs.length > 0) {
                    ...
                    Swal.fire({
                        ...
                        if (isConfirm.value) {
                            $.ajax(
                                {
                                    url: "{{route('admin.gasStations.delete')}}",
                                    type: 'post',
                                    dataType: "JSON",
                                    data: {
                                        "id": checkIDs,

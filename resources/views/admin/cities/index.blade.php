                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('admin.cities.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">{{trans('labels.settings.cities_tap')}}</th>
                                <th class="min-w-125px text-start">{{trans('labels.inputs.country')}}</th>
                                ...
                                <!--begin::Form-->
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <label class="required fw-semibold fs-6 mb-2">{{trans('labels.inputs.country')}}</label>
                                            <select name="country_id" id="country_id" data-control="select2" data-placeholder="{{trans('labels.inputs.select')}}" data-hide-search="true" class="form-select form-select-solid fw-bold">

            ...
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-db-table-filter="search" id="search" name="search"
                               class="form-control form-control-solid bg-light-dark text-dark w-250px ps-14"
                               placeholder="{{transAdmin('Search Yachts')}}"/>
                    </div>
                </div>
                <div class="card-toolbar">
                    <!--begin::Toolbar-->
                    <div class="d-flex justify-content-end dbuttons">
                        <button type="button" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3"
            ...
            <div class="card-body py-4">
                ...
                <table class="table align-middle table-rounded table-striped table-row-dashed fs-6"
                    ...
                    <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px text-start">{{transAdmin('Yachts')}}</th>
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            ...
                            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <label class="required fw-semibold fs-6 mb-2">{{trans('labels.inputs.active')}}
                                        ؟</label>
                                    <select name="is_approved" id="is_approved" data-control="select2"
                                            data-placeholder="اختـر ..." data-hide-search="true"
                            ...
                            <div class="text-center pt-15">
                                <button type="button" class="btn btn-light me-3" data-bs-dismiss="modal">Discard
                                </button>
...
@section('script')
    ...
    <script>
        function changeYachtsStatus(id) {
            var status_id = document.getElementById('changeStatus').value;
            $.ajax(
                {
                    url: "{{route('admin.yachts.updateStatus')}}",
                    type: 'post',
                    dataType: "JSON",
                    data: {
                        "id": id,

...
<div id="kt_app_content_container" class="app-container container-fluid">
    <div class="card">
            ...
            <div class="card-body p-9">
                ...
                <div class="row mb-8">
                    <div class="col-xl-2">
                        <div class="fs-6 fw-semibold">{{trans('labels.inputs.title')}} EN</div>
                    </div>
                    <div class="col-lg-9">
                ...
                <div class="row mb-8">
                    <div class="col-xl-2">
                        <div class="fs-6 fw-semibold">{{trans('labels.inputs.title')}} AR</div>
                    </div>
                    <div class="col-lg-9">
                ...
                <div class="row mb-8">
                    <div class="col-xl-2">
                        <div class="fs-6 fw-semibold">{{trans('labels.inputs.body')}} EN</div>
                    </div>
                    <div class="col-lg-9">
                        <div class="fw-bold fs-5">{{$data->body_en}}</div>
                    </div>
                </div>

                <div class="row mb-8">
                    <div class="col-xl-2">
                        <div class="fs-6 fw-semibold">{{trans('labels.inputs.body')}} AR</div>
                    </div>
                    <div class="col-lg-9">
                        <div class="fw-bold fs-5">{{$data->body_ar}}</div>
                    </div>
                </div>

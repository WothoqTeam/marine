    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form action="{{route('admin.faqs.update')}}" method="POST" enctype="multipart/form-data" id="kt_account_profile_details_form" class="form">
                    @csrf
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="title_en" placeholder="{{trans('labels.inputs.title')}} EN" value="{{$data->title_en}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                            </div>
                        </div>
                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-6">{{trans('labels.inputs.title')}} AR</label>
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="title_ar" placeholder="{{trans('labels.inputs.title')}} AR" value="{{$data->title_ar}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="body_en" placeholder="{{trans('labels.inputs.body')}} EN" value="{{$data->body_en}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                            </div>
                        </div>
                        <div class="row mb-6">
                            <label class="col-lg-2 col-form-label required fw-semibold fs-6">{{trans('labels.inputs.name')}} AR</label>
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="body_ar" placeholder="{{trans('labels.inputs.body')}} AR" value="{{$data->body_ar}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" />
                            </div>
                        </div>
